...
/***/ (function(module, exports, __webpack_require__) {
	...
	var albumEvents = __webpack_require__(11);
	var ratingsEvents = __webpack_require__(38);
	var store = __webpack_require__(8);

	var videos = ['https://www.youtube.com/embed/pKDVUu0aePM?start=0' // Pony Bradshaw
	...
	var storeVideos = function storeVideos() {
	  store.videos = videos;
	  // // console.log(store)
	};

	var onLoadVideo = function onLoadVideo() {
	  var array = store.videos;
	  var numOptions = store.videos.length - 1;
	  // // console.log(array)
	  // // console.log(numOptions)
	  var random = Math.floor(Math.random() * (numOptions - 0 + 1)) + 0;
	  var video = array[random];
	  // // console.log(random)
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://trakrank.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(37);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// RESET SIGNUP MODAL
	var resetSignUpModal = function resetSignUpModal() {
	...
	// Reset Sign In Modal
	var resetSignInModal = function resetSignInModal() {
	...
	var signInShow = function signInShow() {
	  $('.signin-hide').hide();
	  $('#launch-video').empty();
	  $('.signin-show').show();
	};
	...
	var resetChangePasswordModal = function resetChangePasswordModal() {
	  // console.log('Resetting signin Modal')
	  $('.changepassmodalalert').hide();
	...
	var signOutShow = function signOutShow() {
	  $('.signin-hide').show();
	  $('.signin-show').hide();
	  $('#content').empty();
	};

	var signOutLoadVideo = function signOutLoadVideo() {
	  var array = store.videos;
	  var numOptions = store.videos.length - 1;
	  // // console.log(array)
	  // // console.log(numOptions)
	...
	module.exports = {
	  ...
	  resetSignUpModal: resetSignUpModal,
	  resetSignInModal: resetSignInModal,
	  resetChangePasswordModal: resetChangePasswordModal,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// CREATE AN ALBUM
	var onCreateAlbum = function onCreateAlbum(event) {
	  event.preventDefault();
	  $('.add-album-modal-alert').hide();
	  var formValues = $('#addAlbumForm')[0];
	  var data = getFormFields(formValues);
	  ...
	  api.addAlbum(data).then(ui.addAlbumSuccess).then(onGetAlbums).catch(ui.addAlbumFailure);
	};

	// GET ALL ALBUMS
	var onGetAlbums = function onGetAlbums() {
	  api.getAlbums().then(ui.getAlbumsSuccess).then(getUserRatings).catch(ui.getAlbumsFailure);
	};

	// GET ALL User Ratings
	var getUserRatings = function getUserRatings() {
	  // console.log('run get user ratings')
	  api.getRatings().then(ui.getRatingsSuccess).then(ui.calculateStats).catch(ui.getRatingsFailure);
	};

	// Function for User Ratings button
	var launchUserRatingsModal = function launchUserRatingsModal() {
	  getUserRatings();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// ADD ALBUM
	var addAlbum = function addAlbum(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var modalEvents = __webpack_require__(14);
	var store = __webpack_require__(8);
	var showAlbumsTemplate = __webpack_require__(17);
	...
	var addAlbumFailure = function addAlbumFailure(error) {
	...
	var resetAddAlbumModal = function resetAddAlbumModal() {
	...
	// GET ALL ALBUMS
	var getAlbumsSuccess = function getAlbumsSuccess(data) {
	  // console.log(data)
	...
	var getAlbumsFailure = function getAlbumsFailure(error) {}
	// console.log('Unimaginable failure', error)


	// GET RATINGS
	;var getRatingsSuccess = function getRatingsSuccess(data) {
	...
	var getRatingsFailure = function getRatingsFailure(error) {}
	...
	;var calculateStats = function calculateStats() {
	  ...
	  var totalAlbums = store.albums.length;
	  var completeStat = 0;
	  var progressStat = 0;
	  var notStartedStat = 0;
	  var ratingSum = 0;
	  var ratingCount = 0;
	  ...
	  if (store.user_ratings.length === 0) {
	    ...
	    for (var i = 0; i < store.user_ratings.length; i++) {
	  ...
	  var avg = (ratingSum / ratingCount).toFixed(2);
	...
	var resetUserStatsModal = function resetUserStatsModal() {
	...
	var renderAlbums = function renderAlbums(start) {
	  // Clear Contents
	  clearContent();
	  //  Define Variables
	  var showPerPage = 30;
	  var end = start + (showPerPage - 1);
	  var pages = Math.ceil(store.albums.length / showPerPage);
	  var currentPage = start / showPerPage + 1;
	  var renderCounter = 0;
	  var temp = [];
	...
	// GENERATE PAGE NAV
	var generatePageNav = function generatePageNav(needed, current) {
	...
	// SELECT THE PAGE
	var selectPage = function selectPage(event) {
	  event.preventDefault();
	  var showPerPage = 30;
	  var num = event.currentTarget.id.replace('page-', '');
	  var start = (num - 1) * showPerPage;
	...
	module.exports = {
	  ...
	  resetAddAlbumModal: resetAddAlbumModal,
	  getAlbumsSuccess: getAlbumsSuccess,
	  getAlbumsFailure: getAlbumsFailure,
	  getRatingsSuccess: getRatingsSuccess,
	  getRatingsFailure: getRatingsFailure,
	  calculateStats: calculateStats,
	  resetUserStatsModal: resetUserStatsModal,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//  Populate the modals
	var onViewAlbumDetail = function onViewAlbumDetail(event) {
	  event.preventDefault();
	  $('.view-album-modal-alert').hide();
	  var num = event.currentTarget.id.replace('modify-', '');
	  // console.log('view Album Detail')
	  store.album = null;

	  // Store selection to pass as argument
	  api.getAlbumInfo(num).then(ui.getAlbumInfoSuccess).catch(ui.getAlbumInfoFailure);
	...
	var onGetAlbumRating = function onGetAlbumRating(num) {
	  // console.log('run Album get2')
	  api.getAlbumRatingInfo(num).then(ui.getAlbumRatingInfoSuccess).catch(ui.getAlbumRatingInfoFailure);
	};

	module.exports = {
	  onViewAlbumDetail: onViewAlbumDetail,
	  onGetAlbumRating: onGetAlbumRating
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getAlbumInfo = function getAlbumInfo(id) {
	  return $.ajax({
	...
	var getAlbumRatingInfo = function getAlbumRatingInfo(id) {
	  // console.log('test')
	  return $.ajax({
	...
	module.exports = {
	  getAlbumRatingInfo: getAlbumRatingInfo,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getAlbumInfoSuccess = function getAlbumInfoSuccess(data) {
	...
	var getAlbumInfoFailure = function getAlbumInfoFailure(error) {
	...
	var getAlbumRatingInfoSuccess = function getAlbumRatingInfoSuccess(data) {
	  // console.log(data)
	...
	var getAlbumRatingInfoFailure = function getAlbumRatingInfoFailure(error) {
	  // console.log(error)
	...
	module.exports = {
	  getAlbumInfoSuccess: getAlbumInfoSuccess,
	  getAlbumInfoFailure: getAlbumInfoFailure,
	  getAlbumRatingInfoSuccess: getAlbumRatingInfoSuccess,
	  getAlbumRatingInfoFailure: getAlbumRatingInfoFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n\n  <div class=\"col-md-4 col-sm-6\" data-id=\""
	    ...
	    + "\" alt=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.album : stack1), depth0))
	    + " album cover\">\n        <div class=\"caption\">\n          <h3>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = blockParams[0][0]) != null ? stack1.ranking : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "          </h3>\n        <h4>Artist: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.artist : stack1), depth0))
	    + "</h4>\n        <h4>Year: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.year : stack1), depth0))
	    + "</h2>\n        <p><button href=\"#\" class=\"btn btn-primary rate-album\" role=\"button\" id=\"modify-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" >View Album</button>\n      </div>\n    </div>\n  </div>\n\n";
	  ...
	  return "              # "
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.ranking : stack1), depth0))
	    + " - "
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.album : stack1), depth0))
	    + "\n";
	},"4":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "              N/A - "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.album : stack1), depth0))
	    + "\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n<div class=\"row album-row\">\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.albums : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onResetRating = function onResetRating() {
	  event.preventDefault();
	  $('.view-album-modal-alert').hide();
	  // console.log('run Delete Rating')
	  var userRatingId = $('#rating-reference').text();
	  ...
	  api.resetAlbumRating(userRatingId).then(ui.resetAlbumRatingSuccess).catch(ui.resetAlbumRatingFailure);
	};

	// Patch and Post Update
	var createUpdateRatings = function createUpdateRatings(event) {
	  event.preventDefault();
	  $('.view-album-modal-alert').hide();

	  var ratings = $('#album-rating-select').text();
	  var status = $('#album-status-select').text();
	  var albumId = $('#albumIDDisplay').text();
	  var comment = $('#comment-item').val();

	  // Check to see if you should make an update
	  if (comment === '' && (ratings === 'Rating' || ratings === 'None') && status === 'Album Status') {
	  ...
	  if ($('#rating-reference').text() === '') {
	    api.createAlbumRating(data).then(ui.createAlbumRatingSuccess).catch(ui.updateCreateAlbumFailure);
	  } else {
	    // console.log($('#rating-reference').text())
	    // If Rating found then post
	    var id = $('#rating-reference').text();
	    api.updateAlbumRating(data, id).then(ui.updateAlbumRatingSuccess).catch(ui.updateCreateAlbumFailure);
	  }
	};

	// UI view of selection on modal
	var albumStatusSetState = function albumStatusSetState(event) {
	  event.preventDefault();
	  $('#album-status-select').text(event.currentTarget.text);
	};

	var ratingSetState = function ratingSetState(event) {
	  event.preventDefault();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createAlbumRating = function createAlbumRating(data) {
	...
	var updateAlbumRating = function updateAlbumRating(data, id) {
	...
	var resetAlbumRating = function resetAlbumRating(id) {
	...
	module.exports = {
	  ...
	  resetAlbumRating: resetAlbumRating,
	  createAlbumRating: createAlbumRating,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(8);
	// RESET ALBUM RATING
	var resetAlbumRatingSuccess = function resetAlbumRatingSuccess(data) {
	  // console.log(store)
	...
	var resetAlbumRatingFailure = function resetAlbumRatingFailure(error) {
	  // console.log(store)
	...
	// Reset Rating Modal
	var resetViewAlbumModal = function resetViewAlbumModal() {
	...
	var createAlbumRatingSuccess = function createAlbumRatingSuccess() {
	  // console.log(store)
	...
	// RESET ALBUM RATING
	var updateAlbumRatingSuccess = function updateAlbumRatingSuccess() {
	  // console.log(store)
	...
	var updateCreateAlbumFailure = function updateCreateAlbumFailure(error) {
	  // console.log(store)
	...
	module.exports = {
	  resetAlbumRatingSuccess: resetAlbumRatingSuccess,
	  createAlbumRatingSuccess: createAlbumRatingSuccess,
	  updateAlbumRatingSuccess: updateAlbumRatingSuccess,
	  resetViewAlbumModal: resetViewAlbumModal,
	  resetAlbumRatingFailure: resetAlbumRatingFailure,
	  updateCreateAlbumFailure: updateCreateAlbumFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
